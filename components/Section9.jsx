...
const Section9 = () => {
  return (
    <div class="container mx-auto px-16 py-8 m-16">
      <div class="flex flex-col items-center lg:flex-row">
        <div class="flex justify-center lg:w-1/2 mb-4 lg:mb-0">
          <img
        ...
        <div class="lg:w-1/2 lg:pl-8 flex items-center flex-col">
          <h1 class="text-5xl font-bold mb-2 w-full text-left">
            Why<span class="text-orange-500"> Flamingo Vibe</span>?
          </h1>
