...
const Section1 = () => {
  return (
    <div className="bg-cover bg-no-repeat flex justify-center items-center relative  before:bg-black/40 p-40" style={{ backgroundImage: "url('https://package-2.flamingovibe.com/images/banner/bg.png')" }}>
